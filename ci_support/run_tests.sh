...
## New test
python random_start_sequence.py ci_support/mrf_params.braw.gz ci_support/seq0_file.fasta
...
ccmgen --tree-newick ci_support/phylo.newick --seq0-file ci_support/seq0_file.fasta  --mutation-rate-neff --num-threads 1 ci_support/mrf_params.braw.gz sequences.msa
